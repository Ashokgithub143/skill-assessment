...
import "./MyTable.css";
import { data } from "../../../constants/JobSeekerConstant";
import {
  svgCode,
  svgCodeBarOnly,
  svgThreeDot,
    ...
    <div>
      <table className="table-sm-p1 border">
        <thead>
          <tr>
            <th id="table-td">
              <span className="table-Header-Data">Assessment ID</span>
              <div
            ...
            <th id="table-td">
              <span className="table-Header-Data">No. of topics</span>
              <div
                className="svg-container"
            ...
            <th id="table-td">
              <span className="table-Header-Data">Completion date</span>
              <div
                className="svg-container"
                dangerouslySetInnerHTML={{ __html: svgCode }}
              ></div>
            ...
            <th id="table-td">
              <span className="table-Header-Data">Results</span>
              <div
                className="svg-container"
                dangerouslySetInnerHTML={{ __html: svgCodeBarOnly }}
              ></div>
            ...
            <th id="table-td">
              <span className="table-Header-Data">Action</span>
              <div
                className="svg-container"
                dangerouslySetInnerHTML={{ __html: svgCodeBarOnly }}
              ></div>
        ...
        <tbody>
          {currentRows.map((row, index) => (
            <tr key={index} style={{ height: "2" }}>
              <td scope="row">{row.Assessment_ID}</td>
              <td>{row.Department}</td>
              <td>{row.Level}</td>
              <td>{row.No_of_topics}</td>
              <td colSpan={2}>{row.Email_ID}</td>
              <td>
                <div
                  id={
