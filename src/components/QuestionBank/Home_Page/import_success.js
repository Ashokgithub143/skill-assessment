...
function Import_Success({x_mark_close}){
    const buttonStyle = {
        border: 'none',
        outline: 'none',
    ...
    return( <div className={success_style.rectangle}>
            ...
            <p className={success_style.added_Question}>Questions Imported Successfully</p>
           <p className={success_style.reflected_Question}>Questions has been imported successfully, it will be reflected on question bank in few minutes</p>
        </div>
